...
export default function Page() {
    return (
        <div className="p-6 max-w-6xl mx-auto">
            <h1 className="text-2xl font-semibold mb-4">Non-Fiction</h1>
            <p className="text-sm text-gray-600 mb-4">Showing non-fiction books (no genre tags yet — showing catalog).</p>
